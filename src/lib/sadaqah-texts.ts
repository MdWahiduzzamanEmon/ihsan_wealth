...
export const SADAQAH_LIST_TEXTS: Record<TransLang, {
  ...
  en: { noDonationsYet: "No donations yet", noDonationsDesc: "Start recording your Sadaqah to track your generosity and earn continuous rewards.", donationHistory: "Donation History", donation: "donation", donations: "donations", charityHadith: "Charity does not decrease wealth.", deleteTitle: "Delete Donation", deleteDescription: "Are you sure you want to delete this donation record? This action cannot be undone.", deleteConfirm: "Delete", deleteCancel: "Cancel" },
  bn: { noDonationsYet: "এখনো কোনো দান নেই", noDonationsDesc: "আপনার সাদাকাহ রেকর্ড করা শুরু করুন এবং অবিরত সওয়াব অর্জন করুন।", donationHistory: "দানের ইতিহাস", donation: "টি দান", donations: "টি দান", charityHadith: "সাদাকাহ সম্পদ কমায় না।", deleteTitle: "দান মুছুন", deleteDescription: "আপনি কি এই দানের রেকর্ড মুছে ফেলতে চান? এটি পূর্বাবস্থায় ফেরানো যাবে না।", deleteConfirm: "মুছুন", deleteCancel: "বাতিল" },
  ur: { noDonationsYet: "ابھی تک کوئی عطیہ نہیں", noDonationsDesc: "اپنا صدقہ ریکارڈ کرنا شروع کریں اور مسلسل ثواب حاصل کریں۔", donationHistory: "عطیات کی تاریخ", donation: "عطیہ", donations: "عطیات", charityHadith: "صدقہ مال میں کمی نہیں کرتا۔", deleteTitle: "عطیہ حذف کریں", deleteDescription: "کیا آپ واقعی اس عطیہ کا ریکارڈ حذف کرنا چاہتے ہیں؟ یہ واپس نہیں ہو سکتا۔", deleteConfirm: "حذف کریں", deleteCancel: "منسوخ" },
  ar: { noDonationsYet: "لا توجد تبرعات بعد", noDonationsDesc: "ابدأ بتسجيل صدقاتك لتتبع عطاءك وكسب الأجر المستمر.", donationHistory: "سجل التبرعات", donation: "تبرع", donations: "تبرعات", charityHadith: "ما نقصت صدقة من مال.", deleteTitle: "حذف التبرع", deleteDescription: "هل أنت متأكد أنك تريد حذف سجل هذا التبرع؟ لا يمكن التراجع عن هذا الإجراء.", deleteConfirm: "حذف", deleteCancel: "إلغاء" },
  tr: { noDonationsYet: "Henüz bağış yok", noDonationsDesc: "Cömertliğinizi takip etmek ve sürekli sevap kazanmak için sadakanızı kaydetmeye başlayın.", donationHistory: "Bağış Geçmişi", donation: "bağış", donations: "bağış", charityHadith: "Sadaka malı eksiltmez.", deleteTitle: "Bağışı Sil", deleteDescription: "Bu bağış kaydını silmek istediğinizden emin misiniz? Bu işlem geri alınamaz.", deleteConfirm: "Sil", deleteCancel: "İptal" },
  ms: { noDonationsYet: "Belum ada derma", noDonationsDesc: "Mula merekodkan sedekah anda untuk menjejak kemurahan hati dan mendapat ganjaran berterusan.", donationHistory: "Sejarah Derma", donation: "derma", donations: "derma", charityHadith: "Sedekah tidak mengurangi harta.", deleteTitle: "Padam Derma", deleteDescription: "Adakah anda pasti mahu memadamkan rekod derma ini? Tindakan ini tidak boleh dibatalkan.", deleteConfirm: "Padam", deleteCancel: "Batal" },
  id: { noDonationsYet: "Belum ada donasi", noDonationsDesc: "Mulai mencatat sedekah Anda untuk melacak kedermawanan dan mendapat pahala berkelanjutan.", donationHistory: "Riwayat Donasi", donation: "donasi", donations: "donasi", charityHadith: "Sedekah tidak mengurangi harta.", deleteTitle: "Hapus Donasi", deleteDescription: "Apakah Anda yakin ingin menghapus catatan donasi ini? Tindakan ini tidak dapat dibatalkan.", deleteConfirm: "Hapus", deleteCancel: "Batal" },
};

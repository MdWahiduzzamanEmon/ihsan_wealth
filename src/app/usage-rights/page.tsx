...
const USAGE_CONTENT: Record<string, { title: string; lastUpdated: string; sections: { heading: string; body: string }[] }> = {
  en: {
    ...
    sections: [
      ...
      { heading: "Prayer & Worship Data", body: "Prayer tracking records, Ramadan logs, and tasbih (dhikr counter) records are your personal worship data. You can export or delete them at any time through your account settings." },
      { heading: "Hijri Calendar Accuracy", body: "The app uses Intl.DateTimeFormat with the Umm al-Qura calendar and country-specific moon sighting adjustments. While we strive for accuracy, always verify important Islamic dates with your local religious authorities." },
      { heading: "Islamic Occasion Detection", body: "Islamic event detection (Eid al-Fitr, Eid al-Adha, Ramadan, etc.) is based on calculated Hijri dates and may differ from locally announced dates in some regions due to variations in moon sighting methods." },
  ...
  bn: {
    ...
    sections: [
      ...
      { heading: "নামায ও ইবাদত ডেটা", body: "নামায ট্র্যাকিং রেকর্ড, রমজান লগ এবং তাসবীহ (যিকির কাউন্টার) রেকর্ড আপনার ব্যক্তিগত ইবাদত ডেটা। আপনি যেকোনো সময় আপনার অ্যাকাউন্ট সেটিংসের মাধ্যমে এগুলো রপ্তানি বা মুছে ফেলতে পারেন।" },
      { heading: "হিজরি ক্যালেন্ডারের নির্ভুলতা", body: "অ্যাপটি উম্মুল কুরা ক্যালেন্ডার সহ Intl.DateTimeFormat এবং দেশ-নির্দিষ্ট চাঁদ দেখার সমন্বয় ব্যবহার করে। আমরা নির্ভুলতার জন্য চেষ্টা করলেও, গুরুত্বপূর্ণ ইসলামিক তারিখগুলি সর্বদা আপনার স্থানীয় ধর্মীয় কর্তৃপক্ষের সাথে যাচাই করুন।" },
      { heading: "ইসলামিক উপলক্ষ সনাক্তকরণ", body: "ইসলামিক ইভেন্ট সনাক্তকরণ (ঈদুল ফিতর, ঈদুল আযহা, রমজান ইত্যাদি) গণনাকৃত হিজরি তারিখের উপর ভিত্তি করে এবং চাঁদ দেখার পদ্ধতির ভিন্নতার কারণে কিছু অঞ্চলে স্থানীয়ভাবে ঘোষিত তারিখ থেকে ভিন্ন হতে পারে।" },
  ...
  ur: {
    ...
    sections: [
      ...
      { heading: "نماز اور عبادت کا ڈیٹا", body: "نماز ٹریکنگ ریکارڈ، رمضان لاگز اور تسبیح (ذکر کاؤنٹر) ریکارڈ آپ کا ذاتی عبادت ڈیٹا ہے۔ آپ کسی بھی وقت اپنے اکاؤنٹ سیٹنگز کے ذریعے انہیں برآمد یا حذف کر سکتے ہیں۔" },
      { heading: "ہجری کیلنڈر کی درستگی", body: "ایپ ام القریٰ کیلنڈر کے ساتھ Intl.DateTimeFormat اور ملک کے مطابق چاند دیکھنے کی ایڈجسٹمنٹ استعمال کرتی ہے۔ اگرچہ ہم درستگی کی کوشش کرتے ہیں، اہم اسلامی تاریخیں ہمیشہ اپنی مقامی مذہبی اتھارٹی سے تصدیق کریں۔" },
      { heading: "اسلامی مواقع کی شناخت", body: "اسلامی واقعات کی شناخت (عید الفطر، عید الاضحی، رمضان وغیرہ) حسابی ہجری تاریخوں پر مبنی ہے اور چاند دیکھنے کے طریقوں میں فرق کی وجہ سے بعض علاقوں میں مقامی طور پر اعلان کردہ تاریخوں سے مختلف ہو سکتی ہے۔" },
  ...
  ar: {
    ...
    sections: [
      ...
      { heading: "بيانات الصلاة والعبادة", body: "سجلات تتبع الصلاة وسجلات رمضان وسجلات التسبيح (عداد الذكر) هي بيانات عبادتك الشخصية. يمكنك تصديرها أو حذفها في أي وقت من خلال إعدادات حسابك." },
      { heading: "دقة التقويم الهجري", body: "يستخدم التطبيق Intl.DateTimeFormat مع تقويم أم القرى وتعديلات رؤية الهلال حسب البلد. بينما نسعى للدقة، تحقق دائماً من التواريخ الإسلامية المهمة مع سلطتك الدينية المحلية." },
      { heading: "اكتشاف المناسبات الإسلامية", body: "يعتمد اكتشاف الأحداث الإسلامية (عيد الفطر، عيد الأضحى، رمضان، إلخ) على التواريخ الهجرية المحسوبة وقد يختلف عن التواريخ المعلنة محلياً في بعض المناطق بسبب اختلاف طرق رؤية الهلال." },
  ...
  tr: {
    ...
    sections: [
      ...
      { heading: "Namaz ve Ibadet Verileri", body: "Namaz takip kayıtları, Ramazan kayıtları ve tesbih (zikir sayacı) kayıtları sizin kisisel ibadet verilerinizdir. Bunları istediginiz zaman hesap ayarlarınız uzerinden dısa aktarabilir veya silebilirsiniz." },
      { heading: "Hicri Takvim Dogrulugu", body: "Uygulama, Ummu'l-Kura takvimi ile Intl.DateTimeFormat ve ulkeye ozgu hilal gozlem ayarlamalarını kullanır. Dogruluk icin calısmamıza ragmen, onemli Islam tarihlerini her zaman yerel dini otoritenizle dogrulayın." },
      { heading: "Islami Olay Tespiti", body: "Islami olay tespiti (Ramazan Bayramı, Kurban Bayramı, Ramazan vb.) hesaplanmıs Hicri tarihlere dayanır ve hilal gozlem yontemlerindeki farklılıklar nedeniyle bazı bolgelerde yerel olarak ilan edilen tarihlerden farklı olabilir." },
  ...
  ms: {
    ...
    sections: [
      ...
      { heading: "Data Solat dan Ibadat", body: "Rekod penjejakan solat, log Ramadan dan rekod tasbih (pembilang zikir) adalah data ibadat peribadi anda. Anda boleh mengeksport atau memadamnya pada bila-bila masa melalui tetapan akaun anda." },
      { heading: "Ketepatan Kalendar Hijri", body: "Aplikasi menggunakan Intl.DateTimeFormat dengan kalendar Umm al-Qura dan pelarasan cerapan bulan khusus negara. Walaupun kami berusaha untuk ketepatan, sentiasa sahkan tarikh Islam penting dengan pihak berkuasa agama tempatan anda." },
      { heading: "Pengesanan Peristiwa Islam", body: "Pengesanan peristiwa Islam (Hari Raya Aidilfitri, Hari Raya Haji, Ramadan, dll.) berdasarkan tarikh Hijri yang dikira dan mungkin berbeza daripada tarikh yang diumumkan secara tempatan di sesetengah kawasan kerana perbezaan kaedah cerapan bulan." },
  ...
  id: {
    ...
    sections: [
      ...
      { heading: "Data Sholat dan Ibadah", body: "Catatan pelacakan sholat, log Ramadan, dan catatan tasbih (penghitung dzikir) adalah data ibadah pribadi Anda. Anda dapat mengekspor atau menghapusnya kapan saja melalui pengaturan akun Anda." },
      { heading: "Akurasi Kalender Hijriah", body: "Aplikasi menggunakan Intl.DateTimeFormat dengan kalender Umm al-Qura dan penyesuaian pengamatan bulan khusus negara. Meskipun kami berusaha untuk akurasi, selalu verifikasi tanggal-tanggal Islam penting dengan otoritas keagamaan lokal Anda." },
      { heading: "Deteksi Peristiwa Islam", body: "Deteksi peristiwa Islam (Idul Fitri, Idul Adha, Ramadan, dll.) didasarkan pada tanggal Hijriah yang dihitung dan mungkin berbeda dari tanggal yang diumumkan secara lokal di beberapa wilayah karena variasi metode pengamatan bulan." },

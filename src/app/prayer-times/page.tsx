...
import { getLangFromCountry, PRAYER_PAGE_TEXTS, type TransLang } from "@/lib/islamic-content";
    ...
    >
      ...
      <header className="relative overflow-hidden border-b bg-gradient-to-r from-emerald-900 via-emerald-800 to-emerald-900">
        ...
        <div className="absolute inset-0 opacity-10">
          <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="islamic-header" x="0" y="0" width="60" height="60" patternUnits="userSpaceOnUse">
            ...
            <rect width="100%" height="100%" fill="url(#islamic-header)" />
          </svg>
        </div>
            ...
            <Link href="/" className="flex items-center gap-3 group">
              ...
              <div>
                ...
                <p className="text-xs text-emerald-300/70">
                  {t.prayerTimes} &mdash; مواقيت الصلاة
                </p>
              </div>
            </Link>
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-2xl px-4 py-8">
          ...
          <PrayerTimesDisplay state={state} t={t} lang={lang} />
        </div>
      </main>
      ...
      <footer className="border-t bg-gradient-to-b from-emerald-950 to-emerald-950 px-4 py-8 text-white/80">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="text-xs text-emerald-300/50 italic max-w-md mx-auto">
            &ldquo;{t.footerVerseTranslation}&rdquo;
          </p>
          <p className="text-xs text-emerald-400/40 mt-1">- {t.footerVerseRef}</p>
